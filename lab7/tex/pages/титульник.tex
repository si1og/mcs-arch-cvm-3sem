...
\begin{center}
    ...
    \large Отчёт о выполнении лабораторной работы №7 \\[5pt]
    \large <<Система команд, способы адресации и использование подпрограмм в архитектуре x86-32>>\\[5pt]
    \large Вариант 14\\[20pt]
\end{center}
...
\begin{tabular*}{460pt}{@{\extracolsep{\fill}} l r l}
    Выполнил студент\tabularnewline группы 5130201/40002 & \hspace{50pt} \line(1,0){100} \hspace{-52pt} & Семенов И. А.\\
     & \\
     Проверила \tabularnewline преподаватель & \hspace{50pt} \line(1,0){100} \hspace{-52pt} & Веробова Н. М. \\
     & \\
     & \\
     & \\
